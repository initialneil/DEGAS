...
**Two face options, and you pick one per run:** `pN_face_B.yaml` drives the mesh with
DREAMS-AVATAR's fitted SMPL-X expression, `p1_face_A_dpe.yaml` neutralises the mesh face and
drives it from the published per-frame DPE codes. Both are explained under
[Train your own avatar](#train-your-own-avatar).
...
DEGAS
<br>
The code is released under the [Creative Commons Attribution-NonCommercial 4.0 International Public License](https://creativecommons.org/licenses/by-nc/4.0/legalcode) (CC BY-NC 4.0) for Noncommercial use only. Any commercial use should get formal permission first. This matches the licence of the [DREAMS-AVATAR](https://huggingface.co/datasets/initialneil/DREAMS-AVATAR) dataset. Full text in [`LICENSE.md`](LICENSE.md).

The SMPL-X body model is **not** covered by this licence and is not redistributed here; register at [smpl-x.is.tue.mpg.de](https://smpl-x.is.tue.mpg.de/) and accept their terms separately.
